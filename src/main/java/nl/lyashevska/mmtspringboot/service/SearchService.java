...
public class SearchService {
    ...
    public List<Manuscript> getManuscriptAuthor(String author){
        ...
        // create QueryBuilder for the index on which we want to perform a search.
        // We also need to pass the entity class object in it
        QueryBuilder qb = fullTextEntityManager.getSearchFactory().buildQueryBuilder()
                .forEntity(Manuscript.class)
                .get();
        // make use of the keyword query keyword() which allows us to look for a specific word in a
        // field or fields.
